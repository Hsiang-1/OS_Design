...
def FIFO(jobNum, jobsArriveTime , jobsCostTime):
    ...
    # caculate avg
    jobsAVGCT = sum(jobsCyclingTime) / jobNum
    jobsAVGWCT = sum(jobsWeightedCyclingTime) / jobNum
    # display the answers
    print("--------------------")
    ...
    print("AVG cycling time: ", jobsAVGCT)
    print("AVG weighted cycling time: ", jobsAVGWCT)
    print("--------------------")
    return 1
